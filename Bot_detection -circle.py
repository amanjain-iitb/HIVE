...
lower = {'red':(166, 84, 141), 'green':(50,100,100), 'blue':(97, 100, 117), 'yellow':(23, 59, 119), 'orange':(0, 50, 80)} #assign new item lower['blue'] = (93, 10, 0)
upper = {'red':(186,255,255), 'green':(90,255,255), 'blue':(117,255,255), 'yellow':(54,255,255), 'orange':(20,255,255)}
...
while True:
    ...
    URL = 'http://10.26.90.152:8080/shot.jpg'
